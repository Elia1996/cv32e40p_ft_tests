...
FT_MODULE_NAME = "prefetch_buffer_ft"
# Module to use for fault tolerance
ORIG_DIR="../"
ORIG_MODULE_BASE_NAME = "cv32e40p_"
ORIG_MODULE_NAME = "prefetch_buffer"
PARAM_BASE="PREBUF"
...
data=ElaborateFTTemplate("ft_template.sv", blocks,  ORIG_MODULE_BASE_NAME + ORIG_MODULE_NAME, ORIG_MODULE_NAME, PARAM_BASE)
